...
function logError(context, error, additionalInfo = {}) {
    ...
    console.group(`âŒ [${context}] Error at ${timestamp}`);
...
console.log('%cðŸŽµ Onipaba Music Website', 'font-size: 20px; font-weight: bold; color: #D4AF37;');
